...
# -*- coding: utf-8 -*-
r"""
v_task88_h6.py -- closing (H6), the c-correction hypothesis of Theorem MF.

(H6) [v_task87 section 7.1]:  Lemma DEG's two equalities are used by
v_task60 PART C -- and inherited verbatim by Theorem MF -- with the
...
Usage:  python3 v_task88_h6.py [dhi] [qmax]        (default 120 100)
"""
...
def part5(dlo=61, dhi=120, qmax=100):
    ...
    print(BAR)
    print(r"""
  Tests, all INTEGER tests, exactly those of v_task87 section 5:
  ...
  factors f_i < f are enumerated.  New here is the range (v_task87 stopped
...
def main():
    ...
    print("v_task88_h6.py -- closing (H6), the c-correction hypothesis")
    print("dhi = %d   qmax = %d\n" % (dhi, qmax))
    part1()
    part2()
    part3()
