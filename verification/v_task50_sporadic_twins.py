#!/usr/bin/env python3
# v_task50 -- Fitting-free non-simple twins of the sporadic groups.
#
...
# v_task42_to_prime.md) transported to a sporadic target:  P = U_O l_O*I(K<=A_O)
...
#   * "SP" : exact / upper bound from v_task50_sporadic_twins.g (Lemma SP,
