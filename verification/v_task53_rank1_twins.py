...
#
# Pipeline is the v_task51 (L_2) PILOT, applied per family:
...
# v_task50_sporadic_twins.py; the fast factoriser, the generic iota upper
# bounds and prime_powers_upto are IMPORTED from v_task51_l2_twins.py.
# Exact integer arithmetic throughout.
#
# Usage:
#   python3 v_task53_rank1_twins.py --uniform
#   python3 v_task53_rank1_twins.py --lemK
#   python3 v_task53_rank1_twins.py --rank
#   python3 v_task53_rank1_twins.py --census U3 3000
#   python3 v_task53_rank1_twins.py --census Sz 31
#   python3 v_task53_rank1_twins.py --census Ree 21
#   python3 v_task53_rank1_twins.py --eqchar 121
#   python3 v_task53_rank1_twins.py --sub 100000
...
import v_task50_sporadic_twins as T50
from v_task50_sporadic_twins import (simple_divisors, census, pow_divides,
                                     SPORADIC, TITS, gcd)
import v_task51_l2_twins as T51
from v_task51_l2_twins import (factorint, iota_ub_generic, prime_powers_upto,
                               is_prime_power)
...
def cmd_uniform():
    print("# v_task53 --uniform : STEP 2 (one socle orbit) and STEP 3 (l = 1)")
...
def cmd_lemK():
    print("# v_task53 --lemK : Lemma K analogues, verified on every target")
...
def cmd_rank():
    print("# v_task53 --rank : Lemma R.  Which Lie types can be the socle S_1")
...
def cmd_eqchar(fmax=None):
    print("# v_task53 --eqchar : the EQUAL-characteristic half of the")
...
def cmd_census(fam, lim, raw=False):
    d = FAM[fam]
    qs = d["targets"](lim)
    print("# v_task53 --census %s : Fitting-free NON-SIMPLE twins" % fam)
    print("# %s" % d["label"])
...
def cmd_sub(q1max=20000):
    print("# v_task53 --sub : the residual  c*|S_1| = |S|,  2 <= c | |Out(S_1)|")
