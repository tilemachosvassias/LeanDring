#!/usr/bin/env sage
# =============================================================================
# v_task44_dioph_c6 -- the curve C6 of NOTES.md Sec.4ap/Sec.4ay row 1
#
...
# -- the three points at infinity form one Galois orbit over K = Q(6^(1/3)), so
...
#
# Output: v_task44_dioph_c6_out.txt
# =============================================================================
...
KNOWN = [(-8,-14), (-3,-5), (-1,-1), (-1,0), (-1,1), (0,2), (1,3)]
print()
...
print("="*78)
R.<tt> = QQ[]
K.<th> = NumberField(tt^3 - 6, embedding=RR(6)^(1/3))
EK = E.change_ring(K)
...
print("K = Q(6^(1/3)), the field of the three points at infinity of C")
...
print("     m^3-m in {0,6,24}, i.e. (q,m) in {(-1,-1),(-1,0),(-1,1),(0,2),(1,3)}")
...
print("CONCLUSION")
print("="*78)
print("The integral points of C6 : m^3 - m = 6(q^3+q^2+q+1) are EXACTLY")
print("   q = -8, -3, -1, 0, 1   (m = -14, -5, -1/0/1, 2, 3).")
print("In particular there is NO solution with q >= 2, hence none with q an odd")
print("non-prime prime power.  With Lemma R1-S4-l1 (l* = 1 forced) the S4(q)")
print("odd-non-prime row of residue R1 is CLOSED FOR EVERY n.")
print()
