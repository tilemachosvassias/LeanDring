...
Task3RingInvariants := function(id)
  ...
  Print("Group 64, ", id, "\n");
  Print("  Gamma-point count (F): ", F, "\n");
  Print("  full-D Z-rank (C): ", C, "\n");
  ...
  if Einv <> fail then
    ...
    Print("  Rank of squaring map mod 2: N/A (E not invertible)\n");
    Print("  Dimension of nilradical mod 2: N/A\n");
    Print("  Number of idempotents (F_2 rank): N/A\n");
  fi;
...
Task3RingInvariants(47);
Task3RingInvariants(48);
QUIT;
