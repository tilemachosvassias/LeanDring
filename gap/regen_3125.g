...
# docs/audit_gap_table_algorithm.md). Rows use DG_G_coset (gap/dg_correct.g),
...
#
# Run:  ~/gap-4.15.1/gap -q -b gap/regen_3125.g
...
Read("gap/dg_correct.g");                       # DG_G_coset (generally-correct rows)
