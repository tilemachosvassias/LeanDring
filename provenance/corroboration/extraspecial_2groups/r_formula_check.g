# r_formula_check.g
# Task A: decisive n=3 test of the closed-form r-formula.
# Compute r(G) DIRECTLY (generic method: subgroup conjugacy classes +
# normalizer fusion of linear characters -- NOT the formula's
# stratification) for the two extraspecial groups of order 128 = 2^{1+6}.
# Formula predictions under test: plus type r = 27632, minus type r = 27136.
