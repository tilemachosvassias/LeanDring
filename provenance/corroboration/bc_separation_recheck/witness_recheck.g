# witness_recheck.g -- independent re-derivation of Theorem BC-n, not a
# re-run of the bc_separation script.
#
# PART A  B-side witness: z_e = -r_e built from the reflection formula,
#         det, spinor norm predicted by disc(V)*Q(e), Omega-membership,
#         Centralizer(G,z_e) computed DIRECTLY (bc_separation only computed the
